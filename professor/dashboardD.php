...
<head>
    ...
    <title>Painel do Professor - Projeto Superação</title>
...
<body>
    ...
    <div class="container">
        <div class="welcome-card">
            ...
            <p>Área do Professor. Aqui você pode acessar suas informações.</p>
        </div>
        ...
        <div class="dashboard-grid">
            ...
            <div class="dashboard-card">
                ...
                <h2>Mensagens</h2>
                <p>Acesse suas mensagens e comunicados da instituição.</p>
            </div>
